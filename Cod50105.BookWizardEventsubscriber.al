codeunit 50105 "BookWizardEventsubscriber"
{
    ...
    var
        AssistedSetupRecord: Record Book;
    begin
        TempAggregatedAssistedSetup.AddExtensionAssistedSetup(Page::"Book Wizard",
    ...
    begin
        TempAggregatedAssistedSetup.SetStatus(TempAggregatedAssistedSetup, PAGE::"Book Wizard", GetAssistedSetupStatus(TempAggregatedAssistedSetup));
    end;
